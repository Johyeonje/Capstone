...
public class Request_user_network
{
    public static class NetworkTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            result = HttpURLConnection (url, "",session_key); // 해당 URL로 부터 결과물을 얻어온다.
            return result;
        }
    ...
    public static String HttpURLConnection(String urlString, String params,String SessionString) {
        String lineEnd = "\r\n";
        String info = null;
        try {
            ...
            dos.writeUTF(SessionString); // 다음 전달 받은 세션 스트링을 보낸다.
            //보낸 정보에 대한 과목을 받아 와야함. 관련 JSP 페이지 필요.
